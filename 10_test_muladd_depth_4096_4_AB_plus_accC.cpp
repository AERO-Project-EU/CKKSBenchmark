/*
 * test_muladd_depth_4096_34_AB_plus_accC.cpp
 *
...
void test_muladd_depth_4096_4_AB_plus_accC(double range_limit = 100.0, int run = 10){

	cout << "test_muladd_depth_4096_4_AB_plus_accC(" << run << ")" << endl;
